...
## AND 게이트  
AND 게이트의 진리표는 아래와 같다. 진리표의 결과가 나오기 위해서 W와 θ에 적당한 수를 대입할 수 있다. 이 때 W와 θ는 아래 숫자 이외에 더 존재한다.  
...
## 단층 퍼셉트론의 한계  
![image](https://user-images.githubusercontent.com/100412066/226566109-6ca1ec0d-7503-4cc1-8fc0-520e0ed173c7.png){: width="50%" height="50%"}{: .align-center}  
위와같이 AND 게이트를 시각화 
